from propialpes.modulos.vuelos.dominio.objetos_valor import Odo, ParametroBusca, Segmento, Leg, CodigoIATA, Itinerario
from propialpes.modulos.vuelos.dominio.entidades import Proveedor,Aeropuerto
